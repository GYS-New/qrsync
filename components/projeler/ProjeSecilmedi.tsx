  ...
  return (
    <div style={{ padding: 24 }}>
      <div className="verde-card" style={{ padding: 40, textAlign: 'center', maxWidth: 520, margin: '0 auto' }}>
        <div style={{ width: 56, height: 56, borderRadius: 16, background: '#fff7ed', border: '1px solid #ffd9a0', display: 'grid', placeItems: 'center', margin: '0 auto 16px' }}>
          <Layers size={26} style={{ color: '#ff7f00' }} />
        </div>
        <div style={{ fontSize: 17, fontWeight: 800, color: '#3d1c00', marginBottom: 8 }}>
          Proje Seçilmedi
        </div>
        <div style={{ fontSize: 14, color: '#9a7b6a', lineHeight: 1.6, marginBottom: 24 }}>
        ...
        {projeler.length === 0 ? (
          <div style={{ fontSize: 13, color: '#d4b896' }}>
            ...
            {projeler.map(p => (
              <button
                ...
                style={{
                  ...
                  border: `1px solid ${p.renk ?? '#ffd9a0'}40`,
                  background: `${p.renk ?? '#ff7f00'}08`,
              ...
              >
                <div style={{ width: 10, height: 10, borderRadius: '50%', background: p.renk ?? '#ff7f00', flexShrink: 0 }} />
