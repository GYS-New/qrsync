      ...
      {secondaryValue === undefined ? (
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'flex-start', gap: 34, marginBottom: 7, paddingInline: 10 }}>
          <div style={{ textAlign: 'left' }}>
            ...
            <div style={{ marginTop: 5, fontSize: 15, fontWeight: 700, color: '#6b7280' }}>Toplam</div>
          </div>
          ...
          >
            ...
            <div style={{ marginTop: 5, fontSize: 15, fontWeight: 700, color: '#6b7280' }}>{secondaryLabel ?? ''}</div>
          </div>
        </div>
      )}
