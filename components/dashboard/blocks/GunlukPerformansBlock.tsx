...
export default async function GunlukPerformansBlock({ firmaId, projeId,
  basePath,
  ...
  return (
    <div className="verde-card h-[420px] flex flex-col">
      ...
      <div className="flex-1 flex flex-col" style={{ padding: '14px 18px 16px' }}>
        ...
        {total === 0 && <div style={{ textAlign: 'center', color: '#7a907a', paddingTop: 12, fontSize: 13.5 }}>Bugün henüz kayıt yok</div>}
      </div>
    </div>
  )
}