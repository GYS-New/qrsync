        ...
        >
          ...
          >
            <div style={{ padding:'16px 18px', borderBottom:'1px solid #e8f0e8', display:'flex', alignItems:'center', justifyContent:'space-between' }}>
              <div style={{ fontSize:13, fontWeight:700, color:'#0f1a0f' }}>{editing ? 'Lokasyon Düzenle' : 'Lokasyon Ekle'}</div>
            ...
            <div style={{ padding:18 }}>
              <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:12 }}>
                ...
                <div style={{ gridColumn:'1 / -1' }}>
                  ...
                  <div style={{ marginTop:6, fontSize:11, color:'#7a907a' }}>NFC etiketi için kullanılacak benzersiz token.</div>
                </div>
                {editing ? (
                ...
                <div style={{ gridColumn:'1 / -1' }}>
                  ...
                  <div style={{ marginTop:6, fontSize:11, color:'#7a907a' }}>Aktif ise personel görevi önce başlatır, sonra tamamlar. Pasif ise görev doğrudan tamamlanır.</div>
                </div>
                <div style={{ gridColumn:'1 / -1' }}>
                  ...
                  <div style={{ marginTop:6, fontSize:11, color:'#7a907a' }}>Checklist şablonlarını Yönetim → Checklist Şablonları ekranından oluşturabilirsiniz.</div>
                </div>
              </div>
              ...
              {parentId && <div style={{ marginTop:10, fontSize:11, color:'#7a907a' }}>Alt lokasyon olarak eklenecek.</div>}
            </div>
          </div>
        </div>
      )}
