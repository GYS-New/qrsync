    ...
    <div style={{ padding: '24px 28px' }}>
      <div className="verde-card">
        ...
        >
          ...
          <label style={{ display: 'flex', gap: 6, alignItems: 'center', fontSize: 12.5, color: '#4b5563' }}>
            ...
            return (
              <div
                ...
                style={{
                  ...
                  borderRadius: 8,
                  background: n.okundu ? '#fff' : '#f9fafb',
                  marginBottom: 10,
                  overflow: 'hidden',
                }}
              >
                ...
                >
                  ...
                  {!selectionMode && <div style={{ color: '#6b7280', fontSize: 12 }}>{expanded ? '▾' : '▸'}</div>}
                </div>

                {/* Details */}
                {expanded && (
                  <div style={{ padding: '12px 12px', borderTop: '1px solid #f3f4f6', background: '#fff' }}>
                    <div style={{ fontSize: 12.5, color: '#4b5563', whiteSpace: 'pre-wrap' }}>{cleanMessage(n.mesaj ?? '')}</div>
