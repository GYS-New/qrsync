...
const CRONLAR: CronKarti[] = [
  ...
  { tip: 'personel_destek', ad: 'Personel Görev Desteği — Oyak Renault', aciklama: 'Renault projesinde vardiya bitiminden 30 dk sonra BEKLEMEDE görevleri ZAMANINDA_YAPILAMAYAN olarak destek personeline yazar (V bitişleri: 07:30, 15:30, 23:30).', periyot: '00:00, 08:00, 16:00 TRT', projeId: PROJE_ID.RENAULT },
  { tip: 'personel_destek', ad: 'Personel Görev Desteği — Çanakkale',      aciklama: 'Çanakkale projesinde vardiya bitiminden 30 dk sonra BEKLEMEDE görevleri ZAMANINDA_YAPILAMAYAN olarak destek personeline yazar (V bitişleri: 08:00, 16:00, 00:00).', periyot: '00:30, 08:30, 16:30 TRT', projeId: PROJE_ID.CANAKKALE },
