    ...
    <div style={{ display: 'grid', gap: 16 }}>
      <div className="verde-card" style={{ padding: 18 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 12 }}>
          ...
          <div>
            <div style={{ fontWeight: 800, color: '#0f1a0f' }}>{me.isim_soyisim}</div>
            <div style={{ fontSize: 12, color: '#7a907a' }}>{me.email}</div>
          </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: 16, alignItems: 'start' }}>
        <div className="verde-card" style={{ padding: 18 }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
            <div>
              <div style={{ fontWeight: 800, color: '#0f1a0f' }}>E-posta Değiştir</div>
              <div style={{ fontSize: 12, color: '#7a907a' }}>Yeni e-posta ve mevcut şifreniz ile güncelleyin.</div>
            </div>
          </div>
        ...
        <div className="verde-card" style={{ padding: 18 }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
            <div>
              <div style={{ fontWeight: 800, color: '#0f1a0f' }}>Şifre Değiştir</div>
              <div style={{ fontSize: 12, color: '#7a907a' }}>Yeni şifreniz en az 6 karakter olmalıdır.</div>
            </div>
          </div>
...
function Field({ label, children }: { label: string; children: React.ReactNode }) {
  return (
    <label style={{ display: 'grid', gap: 6 }}>
      <span style={{ fontSize: 12, color: '#7a907a' }}>{label}</span>
      {children}
    </label>
  )
}
