...
function ReportCard({
  ...
  return (
    <div className="verde-card" style={{ padding: 18, display: 'flex', flexDirection: 'column', gap: 16 }}>
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 16 }}>
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 8 }}>
            <div style={{ width: 36, height: 36, borderRadius: 10, background: '#f9fafb', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#1f2937' }}>
              <FileText size={18} />
            </div>
            <div>
              <h3 style={{ fontSize: 18, fontWeight: 800, color: '#111827' }}>{report.title}</h3>
              <p style={{ fontSize: 13.5, color: '#4b5563', marginTop: 4 }}>{report.description}</p>
            </div>
          </div>
        </div>
        <div style={{ padding: '6px 10px', borderRadius: 999, border: '1px solid #e5e7eb', background: '#f8fbf8', fontSize: 12.5, fontWeight: 700, color: '#4b5563' }}>
          {selectedCountLabel}
        </div>
      </div>
      ...
      <div style={{ border: '1px solid #f3f4f6', borderRadius: 10, padding: 14, background: '#fbfdfb' }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12, gap: 12 }}>
          <div>
            <div style={{ fontSize: 13, fontWeight: 800, color: '#374151', marginBottom: 4 }}>Rapor Parametreleri</div>
            <div style={{ fontSize: 12.5, color: '#6b7280' }}>İstenen rapor kolonlarını seçin. Tüm kolonlar seçiliyse tam veri çıktısı alınır.</div>
          </div>
          <Button
            type="button"
            variant="ghost"
            ...
            return (
              <label
                ...
                style={{
                  ...
                  alignItems: 'center',
                  gap: 10,
                  border: checked ? '1px solid #374151' : '1px solid #e5e7eb',
                  borderRadius: 10,
                  padding: '10px 12px',
              ...
              >
                ...
                />
                <span style={{ fontSize: 13.5, color: '#374151', fontWeight: 600 }}>{column.label}</span>
              </label>
            )
          })}
        </div>
    ...
    <div>
      ...
      <div style={{ padding: 24, display: 'flex', flexDirection: 'column', gap: 18 }}>
        <div className="verde-card" style={{ padding: 18, display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 16, flexWrap: 'wrap' }}>
          <div>
            <h2 style={{ fontSize: 20, fontWeight: 800, color: '#111827', marginBottom: 6 }}>Ham Veri Raporları</h2>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, flexWrap: 'wrap', justifyContent: 'flex-end' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '10px 12px', borderRadius: 10, border: '1px solid #e5e7eb', background: '#f8fbf8' }}>
