    ...
    <ConfirmCtx.Provider value={value}>
      ...
      {confirmOpen && confirmOpts && (
        ...
        >
          ...
          >
            <div style={{ padding: '14px 16px', borderBottom: '1px solid #e8f0e8', display: 'flex', alignItems: 'center', gap: 10 }}>
              <div style={{ fontSize: 18 }}>{confirmOpts.variant === 'danger' ? '⚠️' : '✅'}</div>
              <div style={{ fontSize: 13.5, fontWeight: 800, color: '#0f1a0f' }}>{confirmOpts.title ?? 'Onay'}</div>
              <button
            ...
            <div style={{ padding: 14, borderTop: '1px solid #e8f0e8', display: 'flex', justifyContent: 'flex-end', gap: 8 }}>
        ...
        >
          ...
          >
            <div style={{ padding: '14px 16px', borderBottom: '1px solid #e8f0e8', display: 'flex', alignItems: 'center', gap: 10 }}>
              ...
              <div style={{ fontSize: 13.5, fontWeight: 800, color: '#0f1a0f' }}>{choiceOpts.title ?? 'Seçin'}</div>
              <button
              ...
              {choiceOpts.options.map((opt) => (
                <button
                  ...
                  style={{
                    ...
                    background: opt.value === 'hard' ? '#fff5f5' : '#f7fbf7',
                  }}
                  onMouseEnter={e => (e.currentTarget.style.background = opt.value === 'hard' ? '#ffe4e4' : '#ecf5ec')}
                  onMouseLeave={e => (e.currentTarget.style.background = opt.value === 'hard' ? '#fff5f5' : '#f7fbf7')}
                >
            ...
            <div style={{ padding: '10px 16px', borderTop: '1px solid #e8f0e8', display: 'flex', justifyContent: 'flex-end' }}>
