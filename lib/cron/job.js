...
function initArsivCron() {
  ...
  // Vardiya bitişinden 30 dk SONRA: 00:00, 08:00, 16:00 TRT → 21:00, 05:00, 13:00 UTC
  // (Yeni OYAK vardiya saatleri: V1 23:30-07:30 / V2 07:30-15:30 / V3 15:30-23:30)
  ...
  //
  // NOT (2026-05-08): Schedule 15 → 30 dk grace. Sebebi: gun_ici_durum_guncelle
  // her dakika çalışıp ACIK→BEKLEMEDE geçişini yapıyor; vardiya bitiminde hepsi
  // tam saat üzerinde değil bitiş+14 dk'ya kadar dağılıyor. PD'nin tüm BEKLEMEDE
  // geçişler tamamlandıktan sonra çalışması için 30 dk grace verildi.
  // NOT (2026-06-01): Vardiya saat değişikliği — eski 30 21,5,13 (00:30/08:30/16:30)
  // → yeni 0 21,5,13 (00:00/08:00/16:00). Yeni vardiya bitişleri 23:30/07:30/15:30.
  cron.schedule('0 21,5,13 * * *', async () => {
    try {
  ...
  console.log('[CRON] Personel görev desteği cron başlatıldı (vardiya bitişinden 30 dk sonra: 00:00, 08:00, 16:00 TRT)')
