...
function initArsivCron() {
  ...
  // Vardiya bitişine 15 dk kala: 07:45, 15:45, 23:45 TRT → 04:45, 12:45, 20:45 UTC
  // Bitmek üzere olan vardiyanın tamamlanmamış görevlerini hedef % oranında kapatır.
  cron.schedule('45 4,12,20 * * *', async () => {
    try {
  ...
  console.log('[CRON] Personel görev desteği cron başlatıldı (vardiya bitişine 15 dk kala: 07:45, 15:45, 23:45 TRT)')
