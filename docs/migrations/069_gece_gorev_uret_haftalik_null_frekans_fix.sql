-- 069: gece_gorev_uret — haftalık branch'inde NULL gunluk_frekans_sayisi düzeltmesi
--
-- Hata: 31 May 2026 23:30 TR cron çalıştığında "null value in column gunluk_frekans_sayisi
-- of relation canli_gorevler violates not-null constraint" hatasıyla 1 Haz görevleri
-- üretilemedi. Sebep: haftalık branch'te INSERT VALUES'a NULL geçiliyordu, oysa
-- haftalık kurallarda r.gunluk_frekans_sayisi doğal olarak NULL.
--
-- Düzeltme: Hem haftalık hem günlük INSERT'lerde COALESCE(r.gunluk_frekans_sayisi, 1).
-- Bu sayede haftalık kurallarda 1 (anlamlı default) yazılır.
  ...
  LOOP
    ...
    IF r.frekans_tipi = 'haftalik' THEN
      ...
      INSERT INTO canli_gorevler (
        ...
        r.olusturan_id, COALESCE(r.gunluk_frekans_sayisi, 1), r.id, 'haftalik',
        p_tarih
      );
