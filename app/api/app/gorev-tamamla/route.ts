...
export async function POST(req: Request) {
  try {
    ...
    if (gorevTipi === 'gorevler') {
      // Istasyon revizyonu (2026-07-09): Oto Yikama gorevi tamamlandiginda
      // gorevler.lokasyon_id = islemi yapan personelin kayitli istasyonu.
      // Aracin varsayilan istasyonu sadece kayit — gercek islem lokasyonu personelden.
