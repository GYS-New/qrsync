      ...
      <div style={{padding:'24px 28px'}}>
        <div className="verde-card" style={{maxWidth:720}}>
          <div style={{padding:'16px 18px', borderBottom:'1px solid #f3f4f6'}}>
            <div style={{fontSize:13,fontWeight:700,color:'#111827'}}>Yeni Firma Bilgileri</div>
          </div>
          <form onSubmit={handleSave} style={{padding:20}}>
            ...
            <div style={{ marginBottom: 14 }}>
              ...
              />
              <div style={{ fontSize: 11.5, color: '#6b7280', marginTop: 6 }}>Logo dosyası otomatik küçültülerek yüklenir.</div>
            </div>
            <div style={{marginBottom:14}}>
              ...
              <div style={{display:'flex',flexDirection:'column',gap:8}}>
                <label style={{display:'flex',alignItems:'center',gap:8,fontSize:14,color:'#111827',cursor:'pointer'}}>
