...
export default async function SAMobilHataLogPage() {
  ...
  return (
    <div>
      <Topbar title="Mobil Hata Log" base="/sa"
        breadcrumbs={[{ label: 'Sistem' }, { label: 'Sistem Logları', href: '/sa/dashboard/sistem-loglari' }, { label: 'Mobil Hata Log' }]} />
      <MobilHataLogClient isSA={true} firmalarListesi={firmalar ?? []} />
    </div>
  )
}
